...
Test(sf_memsuite_student, malloc_an_Integer_check_freelist2, .init = sf_mem_init, .fini = sf_mem_fini) {
	sf_errno = 0;
	int *x = sf_malloc(sizeof(double));
	int *y = sf_malloc(sizeof(double));
...
Test(sf_memsuite_student, free_coalesce_up_to_dowm, .init = sf_mem_init, .fini = sf_mem_fini) {
	void *u = sf_malloc(200);
	/* void *v = */
	void *w = sf_malloc(200);
	/* void *x = */ sf_malloc(500);
...
Test(sf_memsuite_student, free_coalesce_middle, .init = sf_mem_init, .fini = sf_mem_fini) {
	void *u = sf_malloc(200);
	/* void *v = */void *a = sf_malloc(500);
	void *w = sf_malloc(200);
	/* void *x = */ ;
...
Test(sf_memsuite_student, malloc_large, .init = sf_mem_init, .fini = sf_mem_fini) {
	sf_errno = 0;
	sf_malloc(3000);
	sf_malloc(3000);
	sf_malloc(4000);
...
Test(sf_memsuite_student, malloc_3_small_block, .init = sf_mem_init, .fini = sf_mem_fini) {
	sf_errno = 0;
	sf_malloc(1);
	sf_malloc(2);
	sf_malloc(3);
